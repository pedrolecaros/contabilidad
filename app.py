...
from routes import main, empresas, asientos, cuentas, importar, pendientes, reportes, validacion, conciliacion, contrapartes, remuneraciones, prestamos, dashboard, buscar, tributario, papelera, notas, historial, respaldos_locales, documentos, api
...
def create_app(config_override=None):
    ...
    app.register_blueprint(respaldos_locales.bp)
